...
if __name__ == '__main__':
    ...
    dataset_path ='./wear_mask/unweare_mask'
    save_dataset_path = './wear_mask/output_dir'
    #dataset_path = './lfw'
    ...
    print("dir of folder image ",unmasked_paths)
    if unmasked_paths != []:
        fiePath = '/home/minglee/Documents/aiProjects/git_clone/wear_mask_to_face/unweare_mask/record_unmasked_faces.txt'
